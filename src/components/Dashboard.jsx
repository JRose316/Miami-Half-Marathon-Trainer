          ...
          <div>
            <div className="card" style={{marginBottom:14,borderTop:"3px solid #FF3D6B"}}>
              ...
              <div style={{fontSize:10,color:"#9990A0",marginBottom:14}}>
                <span style={{color:"#00C97A",fontWeight:600}}>● At/ahead of pace</span>
                <span style={{margin:"0 6px",color:"#E0D8D0"}}>·</span>
                <span style={{color:"#FF3D6B",fontWeight:600}}>● Behind pace</span>
                <span style={{margin:"0 6px",color:"#E0D8D0"}}>·</span>
                <span style={{color:"#FF9500",fontWeight:600}}>--- Expected</span>
              </div>
              <ResponsiveContainer width="100%" height={220}>
                <ComposedChart data={(() => {
                  ...
                  <Line dataKey="actual" stroke="transparent" strokeWidth={0}
                    dot={(props) => {
